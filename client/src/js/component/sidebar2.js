        ...
        <div className="row h-100">
            ...
            <Box sx={{ display: 'flex' }}>
                ...
                <Drawer variant="permanent" open={open}>
                    ...
                    <Divider />
                    <div className="menu-heading ml-4" style={{ display: open ? 'block' : 'none' }}>
                        <h4>Sidebar Menu</h4>
                    </div>
                    ...
                    <Link className="nav-link" to="/dashboard">
                        ...
                        <ListItem disablePadding sx={{ display: 'block' }}>
                            ...
                            >
                                ...
                                <ListItemText primary={"Budgeting"} sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        </ListItem>
                    </Link>
                    </List>
                    ...
                    <List>
                        ...
                        <ListItem disablePadding sx={{ display: 'block' }}>
                            ...
                            >
                                ...
                                <ListItemText primary={"Options"} sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        </ListItem>
                    </List>
                </Drawer>
