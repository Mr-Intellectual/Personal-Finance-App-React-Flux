...
const Logo = () => (
  <svg viewBox="0 0 448 512" style={{width: '20%', margin: '0 auto'}}>
...
export { Logo, ExpenseIcon, DownIcon, ChartsIcon, CommentsIcon, BudgetIcon, HomeIcon, AppearanceIcon, ReportingIcon, SettingsIcon, OptionsIcon, CollapseIcon, SearchIcon, UsersIcon, MoneyTansferIcon };